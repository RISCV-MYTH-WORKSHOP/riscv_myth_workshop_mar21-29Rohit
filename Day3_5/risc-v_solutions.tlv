...
\TLV
   ...
   |cpu
      @0
         ...
         $pc[31:0] = >>1$reset ? 32'd0 : >>3$valid_taken_br ? >>3$br_tgt_pc :>>3$inc_pc; // PC FOR VALID BRANCH
         
         $start = (>>1$reset && $reset == 0) ? 1'b1 : 1'b0; // VALID PULSE TO AVOID INVALID PULSE
      ...
      @3
         ...
         $rf_wr_en =  $rd_valid && ($rd != 5'b0) && $valid; //REGISTER WRITE FILE
         $rf_wr_index[4:0] = $rd;
